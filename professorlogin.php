...
<body>
	...
	<center><h1 style="font-family: verdana bold;">Professor Portal</h1></center>
	...
	<div class = "container">
		...
		<div class="row">
			<div class="col-md-6 login-left">
				...
				<form action="professorvalidation.php" method="post">
			...
			<div class="col-md-6 login-right">
				...
				<form action="professorregistration.php" method="post">
				<div class="form-group">
					<label> SNU ID </label>
