...
<center><h style="margin-top: 10px">Student Quarantine Delivery Details </h>
	<p id = "newtab" name = "newtab" style="margin-top: 10px">
		<table>
		<tr>
		<th >ID</th>
		<th>Breakfast Timings</th>
		<th>Lunch Timings</th>
		<th>Dinner Timings</th>
		</tr>
		<?php 
		$q13 = "select * from quarantinedelivery";
		...
		echo "<tr>";
		echo "<th>" .$row['id']. "</th>";
		echo "<th>".$row['breakfast_timings']. "</th>";
		echo "<th>".$row['lunch_timings']. "</th>";
		echo "<th>".$row['dinner_timings']. "</th>";
		echo "</tr>";
		echo "</table>";
		}
		}?>
...
<h style="margin-top: 10px">Professor Quarantine Delivery Details </h>
		...
		<?php 
		$q13 = "select * from professorquarantinedelivery";
    	$result13 = mysqli_query($con, $q13);
